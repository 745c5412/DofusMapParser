...
public class Mutable {
    public static void main(String[] args) throws BadMapDataException, BadMapSizeException {
        ...
        MutableDofusMapFactory factory = DofusMapParser.getMutableDofusMapFactory();
        DofusMapFactory f2 = DofusMapParser.getImmutableDofusMapFactory();
        
        MutableDofusMap m1 = factory.buildMap(id, width, height, background, ambianceId, musicId, outdoor, capabilities, mapData);
        DofusMap m2 = f2.buildMap(id, width, height, background, ambianceId, musicId, outdoor, capabilities, mapData);
        
        //m1 and m2 are equals
        assert m1.equals(m2);
        
        //you can modify a mutable map
        m1.setBackground(10);
        m1.getCell(15).setActive(false);
        m1.getCell(1).getObject(Layer.LAYER1).setFlip(true);
        
        //now there are not equals
        assert !m1.equals(m2);
    }
}
